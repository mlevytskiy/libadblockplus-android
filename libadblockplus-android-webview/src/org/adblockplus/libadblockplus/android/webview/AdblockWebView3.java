 ...
 */
public class AdblockWebView3 extends WebView
{
    private static final String TAG = Utils.getTag(AdblockWebView3.class);
  ...
  */
    ...
    public AdblockWebView3(Context context)
    {
        super(context);
        initAbp();
    }

    public AdblockWebView3(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initAbp();
    }

    public AdblockWebView3(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    /**
     * Set to true to see debug log output int AdblockWebView3 and JS console
    ...
    public void setAdblockEngine(final AdblockEngine adblockEngine)
    {
        ...
        final Runnable setRunnable = new Runnable()
        {
            ...
            public void run()
            {
                AdblockWebView3.this.adblockEngine = adblockEngine;
                AdblockWebView3.this.disposeEngine = false;
            }
        };
     ...
     */
    private class AdblockWebView3Client extends WebViewClient
    {
        @Override
    ...
    {
        intWebViewClient = new AdblockWebView3Client();
        applyAdblockEnabled();
    }
...
//     the user can see element visible even though it was hidden on dom event
    ...
    /**
     * Dispose AdblockWebView3 and internal adblockEngine if it was created
     ...
     * @param disposeFinished runnable to run when AdblockWebView3 is disposed
     */
